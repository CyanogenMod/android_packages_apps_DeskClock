...
public class Alarms {
    ...
    public static void setNextAlert(final Context context) {
        boolean hideStatusBarIcon = context.getSharedPreferences(SettingsActivity.PREFERENCES_FILENAME, Context.MODE_PRIVATE).
     ...
     */
    static void setNextAlert(final Context context, final boolean hideStatusBar) {
        final Alarm alarm = calculateNextAlert(context);
        if (alarm != null) {
            enableAlert(context, alarm, alarm.time, hideStatusBar);
        } else {
